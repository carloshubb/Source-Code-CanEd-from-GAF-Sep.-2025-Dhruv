...
<div class="2xl:h-screen">
    <div class="relative isolate overflow-hidden bg-white py-24 sm:py-32 h-full">
        ...
        <div class="relative mx-auto max-w-7xl px-6 lg:px-8">
          ...
          <div class="mx-auto max-w-2xl lg:max-w-xl">
            <div class="flex min-h-full flex-col justify-center py-6 md:py-12 sm:px-6 lg:px-8">
                <div class="sm:mx-auto sm:w-full sm:max-w-md">
                    <img src="{{asset('/images/logo.png')}}" class="l-light text-center mx-auto h-32 md:h-36 lg:h-40" alt="">
                  <h1 class="mt-6 text-center heading1">Sign in to your account</h1>
                </div>
                ...
                <div class="mt-8 sm:mx-auto sm:w-full sm:max-w-md">
                  <div class="bg-white py-8 px-4 shadow sm:rounded-lg sm:px-10">
                    ...
                    <form class="space-y-6" method="POST" action="{{ route('login') }}">
                        @csrf
                      <div>
                        <label for="email" class="block text-base lg:text-lg font-semibold leading-6 text-gray-900 font_nunito">Email address</label>
                        <div class="mt-2">
                      ...
                      <div class="relative">
                        <label for="password" class="block text-base lg:text-lg font-semibold leading-6 text-gray-900 font_nunito">Password</label>
                        <div class="mt-2">
                      ...
                      <div class="flex items-center justify-between">
                        <div class="flex items-center">
                          <input id="remember_me" name="remember_me" type="checkbox" class="h-4 w-4 rounded border-gray-300 text-primary focus:ring-blue-600">
                          <label for="remember_me" class="ml-2 block text-sm md:text-base text-gray-900">Remember me</label>
                        </div>

                        <div class="text-sm">
                            {{-- @if (Route::has('password.request'))
                            <a tabindex="-1" href="{{ route('password.request') }}" class="font-medium text-primary text-base hover:text-indigo-500">Forgot your password?</a>
                            @endif --}}
                            @if (Route::has('password.request'))
                            <a tabindex="-1" href="/admin/forgot-password" class="font-medium text-primary text-sm md:text-base hover:text-red-500">Forgot your password?</a>
                            @endif
                        </div>
                      </div>

                      <div>
                        <button class="w-full can-edu-btn-fill" type="submit">
                            Log in
                        </button>
                      </div>
                    </form>
