...
@section('account-content')
    ...
    @endphp
    <school-ambassador-setting school_id="{{ $data['school'] }}" logged_in_customer="{{ $loggedInCustomer }}" languages_with_names="{{ json_encode($languagesWithNames) }}"></school-ambassador-setting>
@endsection
