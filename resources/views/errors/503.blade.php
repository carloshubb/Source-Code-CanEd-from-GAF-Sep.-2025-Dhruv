        ...
        <div class="flex items-end justify-center h-full w-full relative max-w-screen-2xl mx-auto">
            ...
            <div class="absolute error_outer pt-20 xl:pt-0 w-full md:w-2/3 lg:w-1/2 h-[44rem]">
                ...
                <div class="text-center my-20 w-full mx-auto px-6 lg:my-12">
                    <h1 class="text-white text-2xl font-medium uppercase md:text-3xl">OPPS! We're Sorry!</h1>
                    <p class="text-white text-xl xl:text-2xl ">Our website is currently undergoing maintenance.<br class="hidden md:block"> We'll be back shortly.
                    </p>
                </div>
            </div>
