<div style="padding:20px">
    ...
    <p style="margin: 0 0 10px; text-align: left; font-size: 16px; color: #000;">{{ $emailData['customer'] }} has created Program. As of now it's status is active. To review and update it, follow this link</p>
    @isset($emailData['record']['id'])
        <p style="text-align: left;margin: 16px 0;color: #000;">URL: <a style="color: #b1040e; font-size: 16px; font-weight: 500; text-decoration: underline; display: inline-block;" href="{{ env('APP_URL') . '/admin/'.$emailData['record_url'].'/'.$emailData['record']['id'] . '/edit' }}">View Record</a></p>
    @endisset
