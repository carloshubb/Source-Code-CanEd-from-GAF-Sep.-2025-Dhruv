...
<body>
    ...
    <h3 style="margin: 10px 0; text-align: left; font-size: 24px; line-height: 24px; color: #000;">Hello Admin,</h3>
    <p style="margin: 0 0 10px; text-align: left; font-size: 16px; color: #000;">
        The school <strong>{{ $school_name }}</strong> has reached their threshold of the Master Application.
    </p>
    <p style="margin: 0 0 10px; text-align: left; font-size: 16px; color: #000;">
        The current count is <strong>{{ $current_count }}</strong>, which exceeds the threshold of <strong>{{ $threshold }}</strong>.
    </p>
