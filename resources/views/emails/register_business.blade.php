<div style="padding: 20px">
    ...
    <h3 style="margin: 10px 0; text-align: left; font-size: 24px; line-height: 24px; color: #000;">Dear {{ isset($emailData['businessDetail'][0]->business_name) ? $emailData['businessDetail'][0]->business_name : ''}},</h3>
    <p style="margin: 0 0 10px; text-align: left; font-size: 16px; color: #000">Welcome to Proxima Study, We are thrilled to have you join our platform and provide a space for you to promote your business to a wider audience. This email serves as a warm welcome and confirmation of your successful registration.</p>
    <p style="margin: 0 0 10px; text-align: left; font-size: 16px; color: #000">At Proxima Study, we are committed to supporting businesses like yours by connecting you with potential customers and helping you showcase your company profile. We understand the importance of effective advertising and aim to provide you with a seamless experience to reach your target audience.</p>
    <p style="margin: 0 0 10px; text-align: left; font-size: 16px; color: #000">Your business has been successfully created. You can preview your profile on given url:</p>
    <?php $business_id = isset($emailData['businessDetail'][0]->business_id) ? $emailData['businessDetail'][0]->business_id : ''   ?>
    <p style="margin: 0 0 10px; text-align: left; font-size: 16px; color: #000">URL: <span style="#b1040e">{{ env('APP_URL')."/en/business/".$business_id }}</span></p>
    
    <p style="margin: 0 0 10px; text-align: left; font-size: 16px; color: #000">We are excited to have you on board and look forward to seeing your business thrive on Proxima Study. If you have any questions, need assistance, or have suggestions for improvement, please feel free to reach out to our support team at {{ isset($data['support_email']) ? $data['support_email'] : 'support@proximastudy.com' }}</p>
    
    <p style="margin: 0 0 10px; text-align: left; font-size: 16px; color: #000">Thank you for choosing Proxima Study as your business advertising platform. We are committed to helping you succeed and reach new heights.</p>
    <p style="margin: 0 0 10px; text-align: left; font-size: 16px; color: #000">Welcome aboard!
    </p>
