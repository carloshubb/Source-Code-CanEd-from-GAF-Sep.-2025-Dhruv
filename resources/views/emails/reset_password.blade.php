...
<body>
    ...
    <p style="margin: 10px 0; text-align: left; font-size: 24px; line-height: 24px; color: #000;">Hello,</p>
    ...
    {{-- <p style="text-align: center;margin: 16px 0;">
        ...
        style="border-radius: 4px; background-color: #b1040e; padding: 12px 24px; font-size: 16px; font-weight: bold; color: #ffffff; text-decoration: none; display: inline-block;">Reset password</a>
    </p> --}}
    <p style="text-align: center;margin: 16px 0;">
        <a href="{{ route('reset.password.get', ['lang' => $lang, 'token' => $token]) }}"
