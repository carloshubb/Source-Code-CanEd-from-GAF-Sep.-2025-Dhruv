<div style="padding:20px">
        ...
        <p style="margin: 0 0 10px; text-align: left; font-size: 16px; color: #000;">Welcome to Proxima Study! We are thrilled to have you join us. Your account has been successfully created and this email serves as a warm welcome.</p>

        {{-- <p>URL: {{env('APP_URL').'/en/login'}}</p>
        <p>Username/Email: {{ $emailData['email'] }}</p>
        <p>Password: {{ $emailData['password'] }}</p> --}}

        {{-- <p>You can use these credentials to log in to your account on our website.</p> --}}

        <p style="margin: 0 0 10px; text-align: left; font-size: 16px; color: #000;">If you have any further questions or need guidance, do not hesitate to contact us.</p>
        ...
        {{-- <hr class="cb-hr" />
        <a href="{{ url('/admin/customers') }}">Click here to activate customer</a> --}}
