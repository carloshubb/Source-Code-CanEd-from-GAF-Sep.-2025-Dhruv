...
<head>
    <title>You have an invitation email</title>
</head>
...
<body>
    ...
    {{-- <h1 style="margin: 10px 0; text-align: left; font-size: 24px; line-height: 24px; color: #000;">Dear Admin</h1>
    <p style="margin: 0 0 10px; text-align: left; font-size: 16px; color: #000;">We hope this email finds you well. We are reaching out to inform you that a new article has been suggested.</p>
    <p style="text-align: left;">
        <h3 style="margin: 16px 0; text-align: left; font-size: 24px; line-height: 24px; color: #000;">Suggested Article Details</h3>
    </p> --}}
    <p style="margin: 0 0 10px; text-align: left; font-size: 16px; color: #000;">A user has suggested this article on Proxima Study website: {{ $emailData['suggested_article'] }}.</p>
        ...
        <tr>
            <td class="sm-px-6" style="background-color: #f3f4f6; padding: 16px 48px; text-align: left; box-shadow: 0 1px 2px 0 rgba(0, 0, 0, 0.05)">
                {{-- <table style="margin-left: auto; margin-right: auto; margin-bottom: 8px" cellpadding="0" cellspacing="0" role="none">
                    <tr>
                        <td>
                            <img src="{{ asset('assets/images/canedu.jpg') }}" alt="Canedu Logo" style="max-width: 100%; vertical-align: middle; margin-left: auto; margin-right: auto; width: 192px">
                        </td>
                    </tr>
                </table> --}}
