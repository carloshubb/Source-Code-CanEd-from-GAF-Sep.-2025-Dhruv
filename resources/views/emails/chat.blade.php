<div style="padding:20px">
    ...
    <h3 style="margin: 10px 0; text-align: left; font-size: 24px; line-height: 24px; color: #000;">Dear {{ $emailData['name_to'] }},<h3>
    <p style="margin: 0 0 10px; text-align: left; font-size: 16px; color: #000;">You have a new chat message waiting for you on Proxima Study, We're excited to inform you that someone
        has reached out to you with a message. Here are the details:

    </p>
    <p style="margin: 0 0 10px; text-align: left; font-size: 16px; color: #000;">Sender: {{ $emailData['name_from'] }}</p>
    <p style="margin: 0 0 10px; text-align: left; font-size: 16px; color: #000;">Date: {{ $emailData['message'] }}</p>

    <p style="margin: 0 0 10px; text-align: left; font-size: 16px; color: #000;">To read the message and continue the conversation, please log in to your account on Proxima Study. Don't
        miss out on this opportunity to connect and engage with others in our vibrant community.</p>

    <p style="margin: 0 0 10px; text-align: left; font-size: 16px; color: #000;">If you have any questions or need assistance, feel free to reach out to our support team at
        {{ isset($data['support_email']) ? $data['support_email'] : 'support@proximastudy.com' }}. We're here to help!

    </p>

    <p style="margin: 0 0 10px; text-align: left; font-size: 16px; color: #000;">Thank you for being a part of Proxima Study. We hope you have a meaningful and enjoyable conversation.
