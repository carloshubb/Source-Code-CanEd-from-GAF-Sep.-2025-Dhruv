<div style="padding: 20px;">
    ...
    <table style="width: 100%; margin-bottom: 24px;" cellpadding="0" cellspacing="0" role="none">
        <tr>
            <td style="width: 100%; padding: 0; margin: 0;">
                <img src="{{ asset('assets/images/Email-Banner.jpg') }}" alt="Proxima Study Banner" style="width: 100%; display: block;">
            </td>
        </tr>
    </table>
    ...
    {{-- <h3 style="margin: 10px 0; text-align: left; font-size: 24px; line-height: 24px; color: #000;">
        Dear {{ $emailData['first_name'] }} {{ $emailData['last_name'] }},
    </h3> --}}

    <!-- Welcome Message -->
    <p style="margin: 0 0 10px; text-align: left; font-size: 16px; color: #000;">
        Welcome to Proxima Study! We are thrilled to have you join us. This email serves as a warm welcome and contains your temporary login credentials.
    </p>

    <!-- Credentials Section -->
    <div style="background-color: #f9f9f9; padding: 16px; border-radius: 4px; margin: 16px 0;">
        <p style="margin: 0; font-size: 16px; line-height: 1.5; color: #000;">
    ...
    <!-- Login Button -->
    <a href="{{ url('/en/login') }}" style="border-radius: 4px; background-color: #b1040e; padding: 12px 24px; font-size: 16px; font-weight: bold; color: #ffffff; text-decoration: none; display: inline-block;">
        Login Now
    </a>
    ...
    <table style="width: 100%; margin-top: 24px;" cellpadding="0" cellspacing="0" role="none">
        <tr>
            <td style="background-color: #f3f4f6; padding: 16px 48px; text-align: left; box-shadow: 0 1px 2px 0 rgba(0, 0, 0, 0.05);">
                <!-- Social Media Icons -->
                    ...
                    <tr>
                        <td>
                            <p style="margin: 0; white-space: nowrap; padding-left: 8px; padding-right: 8px; font-size: 16px; color: #000;">
                                ©2025 Proxima Study. All rights reserved.
                            </p>
                        </td>
                    </tr>
                </table>
