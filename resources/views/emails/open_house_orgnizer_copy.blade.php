...
<body>
    ...
    <h1 style="margin: 10px 0; text-align: left; font-size: 24px; line-height: 24px; color: #000;">Hello {{ $emailData['visitor_name'] }}</h1>
    {{-- <p style="margin: 0 0 10px; text-align: left; font-size: 16px; color: #000;">Thank you for reaching out to {{ $emailData['open_house'] }} through our website. We appreciate your interest and taking the time to submit your inquiry. This email serves as a confirmation that we have received your form submission successfully.
    </p> --}}
    {{-- <p style="text-align: left;">
        <h3 style="margin: 16px 0; text-align: left; font-size: 24px; line-height: 24px; color: #000;">Request
             detail</h3>
    </p> --}}
    {{-- <p style="margin: 0 0 10px; text-align: left; font-size: 16px; color: #000;">Name:{{ $emailData['visitor_name'] }}.</p> --}}
    <p style="margin: 0 0 10px; text-align: left; font-size: 16px; color: #000;">This is a copy of the message you sent on Proxima Study.</p>
    <p style="margin: 0 0 10px; text-align: left; font-size: 16px; color: #000;">Message: {{ $emailData['visitor_message'] }}.</p>


    {{-- <p style="margin: 0 0 10px; text-align: left; font-size: 16px; color: #000;">Should you have any urgent concerns or additional information to provide, please feel free to reach out to us directly at {{ isset($data['support_email']) ? $data['support_email'] : 'support@proximastudy.com' }} .

        Once again, thank you for considering {{ $emailData['open_house'] }}. We look forward to assisting you and providing the best possible solution for your needs.
