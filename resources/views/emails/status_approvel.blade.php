<div style="padding:20px">
    ...
    <h3 style="margin: 10px 0; text-align: left; font-size: 24px; line-height: 24px; color: #000;">Dear {{ $emailData['customer'] }} ,<h3>
    <p style="margin: 0 0 10px; text-align: left; font-size: 16px; color: #000;">I hope this email finds you well.</p>
    <p style="margin: 0 0 10px; text-align: left; font-size: 16px; color: #000;">The status for {{ $emailData['record_type_string'] }} is set to {{ $emailData['status'] }}</p>
    <p style="margin: 0 0 10px; text-align: left; font-size: 16px; color: #000;">Thank you for submitting your information on Proxima Study. We appreciate your interest</p>
