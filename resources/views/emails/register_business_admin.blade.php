...
<p style="margin: 10px 0; text-align: left; font-size: 16px; color: #000;">New business register<p>
<ul style="text-align: left;color: #000;">
    <li><strong>Business Name:</strong>{{ isset($emailData['businessDetail'][0]->business_name) ? $emailData['businessDetail'][0]->business_name : ''}}</li>
    <li><strong>Business Email:</strong> {{$emailData['email']}}</li>
</ul>
<hr class="cb-hr" />
<a style="color: #b1040e; font-size: 16px; font-weight: 500; text-decoration: underline; display: inline-block;" href="{{ url('/'.getDefaultLanguage(1)['abbreviation'].'/admin/business')}}">Click here to activate business</a>
