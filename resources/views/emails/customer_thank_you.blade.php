<div style="padding:20px">
    ...
    <p style="margin: 0 0 10px; text-align: left; font-size: 16px; color: #000;">Thank you for submitting the new program on Proxima Study. We have received it.</p>
    <p style="margin: 0 0 10px; text-align: left; font-size: 16px; color: #000;">Have a great day!</p>
