...
<body>
    ...
    <h1 style="margin: 10px 0; text-align: left; font-size: 24px; line-height: 24px; color: #000;">Dear {{ $emailData['business_name'] }}</h1>
    <p style="margin: 0 0 10px; text-align: left; font-size: 16px; color: #000;">You have received a new message from your business profile on Proxima Study
    </p>
    ...
    <p style="margin: 0 0 10px; text-align: left; font-size: 16px; color: #000;">We kindly request you to respond to the customer's inquiry as soon as possible. Providing a prompt and helpful response will greatly enhance your chances of engaging with the customer and potentially securing their business.
