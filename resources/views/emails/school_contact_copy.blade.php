...
<body>
    ...
    <h1 style="margin: 10px 0; text-align: left; font-size: 24px; line-height: 24px; color: #000;">Dear {{ $emailData['visitor_name'] }},</h1>
    <p style="margin: 0 0 10px; text-align: left; font-size: 16px; color: #000;">Thank you for reaching out to {{ $emailData['school_name'] }}. This email serves as a confirmation that your message has been delivered.

    </p>
    <p style="text-align: left;">
        <h3 style="margin: 16px 0; text-align: left; font-size: 24px; line-height: 24px; color: #000;">Message detail</h3>
    </p>
    ...
    <p style="margin: 0 0 10px; text-align: left; font-size: 16px; color: #000;">Should you have any urgent concerns or additional information to provide, please feel free to reach out to us directly at {{ isset($data['support_email']) ? $data['support_email'] : 'support@proximastudy.com' }} .
        ...
        Once again, thank you for considering {{ $emailData['school_name'] }}. We look forward to assisting you and providing the best possible solution for your needs.
