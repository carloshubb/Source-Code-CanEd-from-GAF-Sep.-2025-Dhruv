...
<html lang="en">
<head>
    <title>Your Open House is Live</title>
</head>
<body>
    ...
    <h4 style="box-sizing: border-box; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'; position: relative; font-weight: bold; margin-top: 0; margin: 16px 0; text-align: left; font-size: 24px; line-height: 24px; color: #000;">Hello,</h4>
    <p style="box-sizing: border-box; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'; position: relative; line-height: 1.5em; margin-top: 0; margin: 0 0 10px; text-align: left; font-size: 16px; color: #000;">Your Open House day has been posted successfully on Proxima Study, and can now be viewed here: <a href="{{ $open_day_url }}" style="text-decoration: underline; font-weight: 500;color: #b1040e">{{ $open_day_url }}</a></p>
    <p style="box-sizing: border-box; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'; position: relative; line-height: 1.5em; margin-top: 0; margin: 0 0 10px; text-align: left; font-size: 16px; color: #000;">To edit it, simply log in to your account.</p>
    <p style="box-sizing: border-box; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'; position: relative; line-height: 1.5em; margin-top: 0; margin: 0 0 10px; text-align: left; font-size: 16px; color: #000;">Thank you for your business, and we wish you success.</p>
    <p style="box-sizing: border-box; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'; position: relative; line-height: 1.5em; margin-top: 0; margin: 0 0 10px; text-align: left; font-size: 16px; color: #000;font-weight: 700;">The Proxima Study Team</p>
