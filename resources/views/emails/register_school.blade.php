<div style="padding: 20px">
    ...
    <h3 style="margin: 10px 0; text-align: left; font-size: 24px; line-height: 24px; color: #000;">Dear {{ isset($emailData['schoolDetail'][0]->school_name) ? $emailData['schoolDetail'][0]->school_name : '' }},
    </h3>

    <p style="margin: 0 0 10px; text-align: left; font-size: 16px; color: #000;">Welcome to Proxima Study, We are delighted to have your school join our platform and provide you with a space to
        promote your school programs, connect with students, and facilitate meaningful communication. This email serves
        as a warm welcome and confirmation of your successful registration.</p>

    <p style="margin: 0 0 10px; text-align: left; font-size: 16px; color: #000;">At Proxima Study, we understand the importance of bridging the gap between schools and students, and we are
        committed to supporting your efforts in reaching a wider audience and fostering educational opportunities. Our
        platform aims to connect schools like yours with students who are seeking quality education and unique learning
        experiences.</p>

    <p style="margin: 0 0 10px; text-align: left; font-size: 16px; color: #000;">Your school's has been successfully created. As our admin approve your profile you can preview it on given url:
    </p>
    <?php $school_id = isset($emailData['schoolDetail'][0]->school_id) ? $emailData['schoolDetail'][0]->school_id : ''; ?>
    <p style="margin: 0 0 10px; text-align: left; font-size: 16px; color: #000;">URL: <span style="color: #b1040e">{{ env('APP_URL') . '/en/school/' . $school_id }}</span></p>

    <p style="margin: 0 0 10px; text-align: left; font-size: 16px; color: #000;">We are thrilled to have your school as part of our educational community. If you have any questions, need
        assistance, or have suggestions for improvement, please feel free to reach out to our support team at
        {{ isset($data['support_email']) ? $data['support_email'] : 'support@proximastudy.com' }}. We are here to support your school's growth and success.</p>

    <p style="margin: 0 0 10px; text-align: left; font-size: 16px; color: #000;">Thank you for choosing Proxima Study as your platform for promoting your school programs and connecting with
        students. We look forward to witnessing the positive impact your school will have on the students you engage
        with.</p>
    <p style="margin: 0 0 10px; text-align: left; font-size: 16px; color: #000;">Welcome aboard!</p>
