...
<p style="margin: 0 0 10px; text-align: left; font-size: 16px; color: #000;">New customer register
</p>
<ul style="text-align: left;color: #000;">
    <li><strong>First Name:</strong> {{ $emailData['first_name'] }}</li>
    <li><strong>Last Name:</strong> {{ $emailData['last_name'] }}</li>
    <li><strong>Email:</strong> {{ $emailData['email'] }}</li>
</ul>
<hr class="cb-hr" />
<a href="{{ url('/admin/customers') }}" style="color: #b1040e; font-size: 16px; font-weight: 500; text-decoration: underline; display: inline-block;">Click here to activate customer</a>
