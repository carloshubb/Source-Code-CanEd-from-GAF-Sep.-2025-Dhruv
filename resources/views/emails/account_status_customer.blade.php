<div style="padding:20px">
    ...
    <h3 style="margin: 10px 0; text-align: left; font-size: 24px; line-height: 24px; color: #000;">Dear {{ $emailData['first_name'] }} {{ $emailData['last_name'] }} ,<h3>
    <p style="margin: 0 0 10px; text-align: left; font-size: 16px; color: #000;">I hope this email finds you well. We're excited to share some exciting news and updates from Proxima
        Study</p>
    <p style="margin: 0 0 10px; text-align: left; font-size: 16px; color: #000;">Your account has been successfully set to active</p>
    <p style="margin: 0 0 10px; text-align: left; font-size: 16px; color: #000;">You can use Your credentials to log in to your account on our website on following url.</p>
    <p style="margin: 0 0 10px; text-align: left; font-size: 16px; color: #000;">URL: {{ env('APP_URL') . '/en/login' }}</p>
    <p style="margin: 0 0 10px; text-align: left; font-size: 16px; color: #000;">If you have any further questions or need guidance, please do not hesitate to contact us.</p>
    <p style="margin: 0 0 10px; text-align: left; font-size: 16px; color: #000;">Welcome aboard!
    </p>

    <p style="margin: 0 0 5px; text-align: left;font-weight:700; font-size: 16px; color: #000;">Best regards</p>
