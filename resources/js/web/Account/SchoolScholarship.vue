        ...
        <div class="px-4 sm:px-6">
            <div class="flex flex-col sm:flex-col md:flex-row lg:flex-row items-center justify-between py-4 gap-4 bg-white dark:bg-gray-800">
                <div class="sm:flex-auto">
                    <h2 class="can-school-h2 text-primary">School Scholarships</h2>
                </div>
                <div class="">
                    <button
                        @click="toggleModal"
                        ...
                        >
                            ...
                            <td class="relative py-4 pl-4 pr-3 text-base sm:pl-6">
                                <div class="font-medium text-gray-900">
                                    {{
                                        school_scholarship &&
                                        school_scholarship.study_level
                                            ? school_scholarship.study_level
                                            : ""
                                    }}
                                </div>
                            ...
                            <td class="relative py-4 pl-4 pr-3 text-base sm:pl-6">
                                <div class="font-medium text-gray-900">
                                    {{
                                        school_scholarship &&
                                        school_scholarship.deadline_date
                                            ? school_scholarship.deadline_date
                                            : ""
                                    }}
                                </div>
                            ...
                            <td
                                class="relative py-3.5 px-3 text-center text-sm font-medium gap-2 whitespace-nowrap"
                            >
                                <a
                                    @click.prevent="
                                        editSchoolScholarship(
                                            school_scholarship
                                        )
                                    "
                                    type="button"
...
import SchoolScholarshipModal from "./Modals/SchoolScholarshipModal.vue";
import ScholarshipSetting from "./ScholarshipSetting.vue";
...
export default {
    ...
    methods: {
        toggleModal() {
            this.$store.commit("school_scholarships/setShowModal", 1);
        },
        fetchSchoolScholarships(page_url, type) {
            this.$store.dispatch(
        ...
        editSchoolScholarship(school_scholarship) {
            ...
            this.$store.commit(
                "school_scholarships/setSchoolScholarship",
                school_scholarship
            );
        },
        deleteSchoolScholarship(record) {
      this.$swal
        .fire({
          ...
          preConfirm: (password) => {
            return this.$store
              .dispatch("school_scholarships/deleteSchoolScholarship", {
                id: record.id,
                password: password,
              })
              .then((res) => {
    ...
    created() {
        ...
        this.$store.commit("school_scholarships/setSortBy", "id");
        this.$store.commit("school_scholarships/setSortType", "desc");
