        ...
        >
          <div class="modal-content py-6 text-left px-6">
            <div class="flex justify-between items-center pb-3">
              <div class="can-school-h2 mb-0">Create a new blog</div>
              <div
            ...
            <div class="">
              ...
              >
                <div class="w-full mt-2">
                  <label for="degree" class="block text-base lg:text-lg">Blog title <span class="text-primary">*</span> </label>
                  <input
                  name="title"
                    type="text"
                ...
                <div class="w-full mt-2">
                  <label for="degree" class="block text-base lg:text-lg">Category name <span class="text-primary">*</span> </label>
                  <input
                  name="category_name"
                    type="text"
                    class="mt-2 border w-full border-l-[5px] focus:ring-primary focus:outline-none border-l-primary px-4 py-1.5 rounded border-gray-300"
                ...
                <div class="w-full mt-2" v-if="isDataLoaded">
                  <label for="degree" class="block text-base lg:text-lg mb-2">Short description <span class="text-primary">*</span> </label>
                  <editor
                    @selectionChange="
                ...
                <div class="w-full mt-2" v-if="isDataLoaded">
                  <label for="degree" class="block text-base lg:text-lg mb-2">Detailed description <span class="text-primary">*</span> </label>
                  <editor
                    @selectionChange="
              ...
              <div class="w-full mt-2 mb-6 group">
