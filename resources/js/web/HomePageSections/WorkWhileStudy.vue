        ...
        <div class="py-2">
            <div class="mx-auto container px-2">
                <div class="mx-auto lg:mx-0">
                    <h2 class="heading2 mb-2" v-if="work_while_studying_article_categories?.length == 0">
                        <a :href='"/"+lang+"/articles?category="+home_settings?.article_section_2_category_id'>
                        {{
        ...
        <div class="bg-white py-2">
            <div class="mx-auto container px-2">
                <div
                    ...
                    v-if="work_while_studying_article_categories?.length == 0"
                    >
                    <article
                        class="flex flex-col items-start justify-between"
                        v-for="(article, key) in work_while_studying_articles"
                        :key="key"
                    >
                ...
                <div
                    ...
                    <article
                        class="flex flex-col items-start justify-between"
                        v-for="(category, key) in work_while_studying_article_categories"
                        :key="key"
                    >
                        <div class="relative w-full">
                            <img
...
export default {
    ...
    data() {
        return {
            home_settings: null,
            work_while_studying_articles: null,
            work_while_studying_article_categories: null,
        };
    },
    mounted() {
        this.home_settings = JSON.parse(this.home_page_settings);
        this.work_while_studying_articles = JSON.parse(this.articles);
        this.work_while_studying_article_categories = JSON.parse(this.article_categories);
    },
};
</script>
