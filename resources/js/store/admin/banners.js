...
const banners = {
    ...
    mutations: {
        setBannerDescription(state, payload) {
            state.form.banner_description = payload;
        },
        updateBannerDescription(state, payload) {
            state.form.banner_description[`banner_description_${payload.id}`] = payload.banner_description;
        },
        setBannerButtonText(state, payload) {
            state.form.banner_button_text = payload;
        },
        updateBannerButtonText(state, payload) {
            state.form.banner_button_text[`banner_button_text_${payload.id}`] = payload.banner_button_text;
        },
        setTitle(state, payload) {
            state.form.title = payload;
        },
        updateTitle(state, payload) {
            state.form.title[`title_${payload.id}`] = payload.title;
        },
