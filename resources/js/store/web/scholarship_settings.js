    ...
    mutations: {
        ...
        setScholarshipSetting(state, payload) {
            for (
                ...
                state.form["scholarship_settings_apply_button_link"] = scholarship_settings_apply_button_link;
                state.form["scholarship_settings_apply_button_title"] = scholarship_settings_apply_button_title;
