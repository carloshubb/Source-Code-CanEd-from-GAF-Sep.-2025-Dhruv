            ...
            <div class="px-4 sm:px-6 lg:px-8">
                <div
                    ...
                    <div class="sm:flex-auto">
                        <h1 class="can-edu-h1">Business directories</h1>
                    </div>
                    <div class="mt-4 sm:mt-0 sm:ml-16 sm:flex-none">
                        <router-link :to="{ name: 'admin.business_directories.create' }" class="can-edu-btn-fill">
                ...
                <div
                    ...
                    <div class="relative">
                        <div class="absolute inset-y-0 left-0 flex items-center pl-3 pointer-business_directory-none">
                        ...
                        <form autocomplete="off" @submit.prevent>
                            <input type="text" id="table-search-business_directory"
                                ...
                                placeholder="Search for business directory" v-model="quickSearch" />
                        </form>
                    </div>
                </div>
                      ...
                      <div>
                        <nav class="relative z-0 inline-flex rounded-md shadow-sm -space-x-px" aria-label="Pagination">
                          <a href="#"
                            ...
                            @click.prevent="fetchBusinessDirectories(pagination.prev_page_url)">
                          ...
                          <template v-for="page in getPageNumbers()" :key="page">
                            ...
                            <a v-else href="#"
                              ...
                              }" @click.prevent="fetchBusinessDirectoriesByPage(page)">
                              {{ page }}
                            </a>
                          </template>
                          ...
                          <a href="#"
                            ...
                            @click.prevent="fetchBusinessDirectories(pagination.next_page_url)">
...
export default {
    ...
    const baseUrl = process.env.MIX_ADMIN_API_URL + "business_directories";
    this.fetchBusinessDirectories(`${baseUrl}?page=${page}`);
        // this.$store.dispatch("business_directories/fetchBusinessDirectories");
    },
    watch: {
