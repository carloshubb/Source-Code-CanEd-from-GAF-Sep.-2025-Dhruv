            ...
            <header class="">
                <div class="max-w-full mx-auto px-4 sm:px-6 lg:px-8">
                    <div class="flex items-center justify-between">
                        <h1 class="can-edu-h1">
                            {{ isFormEdit ? 'Edit' : 'Create' }} business directory
                        </h1>
                        <router-link :to="{ name: 'admin.business_directories.index' }" class="can-edu-btn-fill">
                            Back
                        </router-link>
                    </div>
                </div>
                ...
                <div class="max-w-full mx-auto px-4 sm:px-6 lg:px-8">
                    <div class="flex items-center justify-between">
                        <p class="block text-base lg:text-lg  font-FuturaMdCnBT text-primary">
                            Select language(s) of the business directory
                        </p>
                    </div>
                </div>
            </header>
